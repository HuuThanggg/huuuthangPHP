...
<main>
    ...
    <table class="nhanvien-table">
        <thead>
            <tr><th>
                    <a href="add_nhanvien.php">Add nv</a>
                </th></tr>
            <tr>
                <th>Ma NV</th>
                <th>Ten NV</th>
                ...
                <tr class="nhanvien-item">
                    ...
                    <td>
                        <?php if ($nhanvien["phai"] == "NU"): ?>
                            <img src="img/4.jpg" alt="Woman" width="30" height="30" class="gender-image">
                        <?php elseif ($nhanvien["phai"] == "NAM"): ?>
                            <img src="img/3.jpg" alt="Man" width="30" height="30" class="gender-image">
                        <?php endif; ?>
                    </td>
